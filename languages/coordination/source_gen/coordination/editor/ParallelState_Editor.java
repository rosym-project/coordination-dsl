...
public class ParallelState_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_pktb5_a(editorContext, node);
  }

  private EditorCell createCollection_pktb5_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_pktb5_a");
    editorCell.setBig(true);
    editorCell.addEditorCell(this.createConstant_pktb5_a0(editorContext, node));
    editorCell.addEditorCell(this.createProperty_pktb5_b0(editorContext, node));
  ...
  private EditorCell createConstant_pktb5_a0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createProperty_pktb5_b0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createComponent_pktb5_c0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_pktb5_d0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "initial state:");
    editorCell.setCellId("Constant_pktb5_d0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefCell_pktb5_e0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
    provider.setRole("initialstate");
    provider.setNoTargetText("<no initialstate>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new ParallelState_Editor._Inline_pktb5_a4a());
    editorCell = provider.createEditorCell(editorContext);
  ...
  public static class _Inline_pktb5_a4a extends InlineCellProvider {
    public _Inline_pktb5_a4a() {
      super();
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_pktb5_a0e0(editorContext, node);
    }

    private EditorCell createProperty_pktb5_a0e0(EditorContext editorContext, SNode node) {
      CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
      provider.setRole("name");
      provider.setNoTargetText("<no name>");
