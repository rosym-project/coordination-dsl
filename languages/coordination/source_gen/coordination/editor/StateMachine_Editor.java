...
public class StateMachine_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_qpt50r_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefCell_qpt50r_d0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_qpt50r_e0(editorContext, node));
    editorCell.addEditorCell(this.createRefNodeList_qpt50r_f0(editorContext, node));
  ...
  private EditorCell createRefCell_qpt50r_d0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
    provider.setRole("initialstate");
    provider.setNoTargetText("<no initialstate>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new StateMachine_Editor._Inline_qpt50r_a3a());
    editorCell = provider.createEditorCell(editorContext);
  ...
  public static class _Inline_qpt50r_a3a extends InlineCellProvider {
    public _Inline_qpt50r_a3a() {
      super();
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_qpt50r_a0d0(editorContext, node);
    }

    private EditorCell createProperty_qpt50r_a0d0(EditorContext editorContext, SNode node) {
      CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
      provider.setRole("name");
      provider.setNoTargetText("<no name>");
  ...
  private EditorCell createConstant_qpt50r_e0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "Datamodel:");
  ...
  private EditorCell createRefNodeList_qpt50r_f0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new StateMachine_Editor.dataListHandler_qpt50r_f0(node, "data", editorContext);
  ...
  private static class dataListHandler_qpt50r_f0 extends RefNodeListHandler {
    public dataListHandler_qpt50r_f0(SNode ownerNode, String childRole, EditorContext context) {
  ...
  private EditorCell createRefNodeList_qpt50r_h0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new StateMachine_Editor.statesListHandler_qpt50r_h0(node, "states", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Indent(), false);
  ...
  private static class statesListHandler_qpt50r_h0 extends RefNodeListHandler {
    public statesListHandler_qpt50r_h0(SNode ownerNode, String childRole, EditorContext context) {
      super(ownerNode, childRole, context, false);
    }
