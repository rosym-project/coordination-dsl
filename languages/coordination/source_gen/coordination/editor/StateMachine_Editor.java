...
public class StateMachine_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_qpt50r_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "Coordination");
  ...
  private EditorCell createRefNodeList_qpt50r_f0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new StateMachine_Editor.statesListHandler_qpt50r_f0(node, "states", editorContext);
  ...
  private static class statesListHandler_qpt50r_f0 extends RefNodeListHandler {
    public statesListHandler_qpt50r_f0(SNode ownerNode, String childRole, EditorContext context) {
