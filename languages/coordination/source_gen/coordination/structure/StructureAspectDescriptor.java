...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  private static String[] stringSwitchCases_1htk8d_a0a0b = new String[]{"coordination.structure.Action", "coordination.structure.Comment", "coordination.structure.CompositeState", "coordination.structure.Condition", "coordination.structure.FireEvent", "coordination.structure.ICanBeCommented", "coordination.structure.LogMessage", "coordination.structure.ParallelState", "coordination.structure.State", "coordination.structure.StateContainer", "coordination.structure.StateLike", "coordination.structure.StateMachine", "coordination.structure.Transition", "coordination.structure.WaitDuration", "coordination.structure.WaitForEvent"};
}
