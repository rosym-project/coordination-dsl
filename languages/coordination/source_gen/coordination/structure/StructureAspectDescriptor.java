...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 4:
        return new ConceptDescriptorBuilder("coordination.structure.Data").interface_().parents("jetbrains.mps.lang.core.structure.INamedConcept").create();
      case 5:
      ...
      case 6:
        return new ConceptDescriptorBuilder("coordination.structure.GenericData").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "coordination.structure.Data").properties("src", "expr").children(new String[]{"content"}, new boolean[]{true}).alias("data", "").create();
      case 7:
      ...
      case 14:
        return new ConceptDescriptorBuilder("coordination.structure.StateMachine").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "coordination.structure.StateContainer").children(new String[]{"data"}, new boolean[]{true}).create();
      case 15:
